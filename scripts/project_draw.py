...
def main():
    ...
    for tour, bo, label in TOURS:
        ...
        sections.append((label, odds, bracket))
    ...
    for label, odds, bracket in sections:
        html.append(f"<section><h2>{label}</h2>{odds}<details><summary class='sub'>seeded bracket</summary>{bracket}</details></section>")
